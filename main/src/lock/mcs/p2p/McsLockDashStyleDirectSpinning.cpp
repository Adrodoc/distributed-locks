...
class McsLockDashStyleDirectSpinning : public Lock {
 ...
 public:
  static constexpr std::string_view NAME() { return "McsLockDashStyleDirectSpinning"; }

  static constexpr MPI_Aint get_win_size(bool on_master_rank) { return sizeof(memory_layout); }

  static McsLockDashStyleDirectSpinning per_node(
  ...
  McsLockDashStyleDirectSpinning(MPI_Comm comm = MPI_COMM_WORLD, int master_rank = 0)
      : McsLockDashStyleDirectSpinning(
            MpiWindow::allocate(get_win_size(get_rank(comm) == master_rank), comm), master_rank) {}

  McsLockDashStyleDirectSpinning(MpiWindow window, int master_rank = 0)
  ...
  McsLockDashStyleDirectSpinning(McsLockDashStyleDirectSpinning &&other) = default;
