...
#include "Lock.cpp"
#include "log.cpp"
#include "McsLockTwoSidedWithCohortDetection.cpp"
#include "mpi_utils/mpi_utils.cpp"
#include "TktLock.cpp"

class CTktMcsLockTwoSided : public Lock
{
private:
    enum status
    {
    ...
    TktLock global_lock;
    McsLockTwoSidedWithCohortDetection local_lock;

    int status;

public:
    CTktMcsLockTwoSided(const CTktMcsLockTwoSided &) = delete;
    CTktMcsLockTwoSided(const MPI_Comm comm = MPI_COMM_WORLD, const int master_rank = 0)
        : comm{comm},
    ...
    {
        // log() << "entering CTktMcsLockTwoSided" << std::endl;
        // log() << "exiting CTktMcsLockTwoSided" << std::endl;
    }
